...
with DAG(
        ...
        description='ETL процесс для даталейка',
        catchup=False,
    ...
    build_user_zone_report_task = BashOperator(
    ...
    build_week_zone_report_task = BashOperator(
    ...
    build_recommendation_zone_report_task = BashOperator(
    ...
    start >> migrate_geo_events_task >> [build_user_zone_report_task, build_week_zone_report_task, build_recommendation_zone_report_task] >> finish
